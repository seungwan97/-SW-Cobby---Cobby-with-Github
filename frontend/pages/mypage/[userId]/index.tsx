  ...
  return (
    <Fragment>
      <page.PageWrapper>
        ...
        <div>
          뱃지 컴포넌트야
          <TextBox size={20} content={"#Github 어쩌고 저쩌꼬"} />
        ...
        <div>
          ...
          <div>
            ...
            />
            <TextBox size={20} content={"Nickname : baefrica"} />
            <TextBox size={20} content={"Level : 89274"} />
            <TextBox size={20} content={"Number of Costumes : 500"} />
            <TextBox size={20} content={"Number of Quests Completed : 500"} />
          </div>
          <div>LOGOUT</div>
          <div>회원탈퇴</div>
        </div>
